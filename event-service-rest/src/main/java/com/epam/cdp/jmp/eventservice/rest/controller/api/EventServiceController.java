...
public interface EventServiceController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 204, message = "Not found"),
            @ApiResponse(code = 500, message = "Internal Server Error")})
    ResponseEntity<?> getAllEventsByTitle(@ApiParam("Title of the event") String title);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 204, message = "Not found"),
            @ApiResponse(code = 500, message = "Internal Server Error")})
    ResponseEntity<?> getEvent(@ApiParam("Id of the event") BigInteger id);
