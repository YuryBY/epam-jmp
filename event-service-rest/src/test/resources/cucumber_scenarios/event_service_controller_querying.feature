Feature: event_service_controller_queries
  ...
  client call POST /l0/v1.0/event-service
    ...
    When the client calls POST /l0/v1.0/event-service and Body contains Event with title: "the_title_1", place: "the_place_1", speaker: "the_speaker_1", eventType: "TECHTALK", dateTime: "2019-03-25T14:27:35.007Z".
